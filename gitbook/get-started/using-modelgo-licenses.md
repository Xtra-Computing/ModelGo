...
<table><thead><tr><th width="192">License Full Name</th><th>ModelGo Attribution-NonCommercial-OpenSource License 2.0</th></tr></thead><tbody><tr><td>Short Identifier</td><td>MG-BY-NC-OS-2.0</td></tr><tr><td>Tags</td><td>Copyleft, No Commercial Use, Disclose Source, Non-Sublicensable, Irrevocable</td></tr><tr><td>Who Owns Derivative Works</td><td>Licensor</td></tr><tr><td>Purposes</td><td>Further to the provisions of MG-BY-NC, recipients should also open-source any derivatives they create.</td></tr></tbody></table>

{% embed url="https://github.com/Xtra-Computing/ModelGo/blob/main/MG_licenses/V2/MG-BY-NC-OS-2.0.txt" %}
👆Get the Full Text of this License
{% endembed %}
{% endtab %}
{% endtabs %}
...
```
  ...
  Licensed under the ModelGo Attribution-NonCommercial-ResponsibleAI License, Version 2.0 (the "License");
