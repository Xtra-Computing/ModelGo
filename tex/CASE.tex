...
Consequently, directly analyzing real-world ML projects can result in uncertainty, over-optimistic results, and often fail to detect any license conflicts.
...
\begin{table}[t]
    \caption{Specifications of AI components used in case studies, which include \textcolor{Copyleft}{Copyleft License}, \textcolor{Permissive}{Permissive License}, \textcolor{Public}{Public Domain License} and Not-Public License.}
    \vspace{-3mm}
    \footnotesize
    \label{tab:works}
